...
/****** Object:  Database [Payments]    Script Date: 22.05.2023 12:35:48 ******/
CREATE DATABASE [Payments]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Payments', FILENAME = N'D:\prila\MSSQL16.SQLEXPRESS\MSSQL\DATA\Payments.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Payments_log', FILENAME = N'D:\prila\MSSQL16.SQLEXPRESS\MSSQL\DATA\Payments_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Payments] SET QUERY_STORE = ON
GO

ALTER DATABASE [Payments] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
